...
const Analytics = () => {
  return (
    <div className="flex-1 flex flex-col bg-white p-12 overflow-y-auto">
      ...
      <header className="grid grid-cols-3 gap-8 mb-12">
        {/* Total Revenue */}
        <div className="p-8 bg-slate-50 rounded-[32px] border border-slate-100 shadow-sm relative overflow-hidden group">
          ...
          <div className="flex items-end justify-between">
            <h2 className="text-5xl font-black text-slate-900 tracking-tighter">₱1.4M</h2>
        ...
        <div className="p-8 bg-slate-50 rounded-[32px] border border-slate-100 shadow-sm relative overflow-hidden group">
          ...
          <h2 className="text-5xl font-black text-slate-900 tracking-tighter">₱900K</h2>
        </div>

        {/* Pending Inquiries */}
        <div className="p-8 bg-slate-900 rounded-[32px] shadow-xl relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-7xl font-black text-white tracking-tighter">1</h2>
      ...
      <section className="bg-white rounded-[40px] border border-slate-100 p-12 shadow-sm">
